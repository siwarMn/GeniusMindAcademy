...
class Quiz {
  ...
  final String?
      correct; // Assuming correct response is represented by an integer
  final int? levelId;
  Quiz({
    this.id,
    this.question,
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            setState(() {
                              selectedOptionIndex =
                                  0; // Update selected option index to the first option
                            });
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: selectedOptionIndex == 0
                                ? Colors.green
                                : null, // Highlight color for correct option
                          ),
                        ...
                        ElevatedButton(
                          onPressed: () {
                            setState(() {
                              selectedOptionIndex =
                                  1; // Update selected option index to the second option
                            });
                          },
                          style: ElevatedButton.styleFrom(
                        ...
                        ElevatedButton(
                          onPressed: () {
                            setState(() {
                              selectedOptionIndex =
                                  2; // Update selected option index to the third option
                            });
                          },
                          style: ElevatedButton.styleFrom(
